...
class  UserCreateUpdate  extends  Component {
    ...
    // If the the user visits a user/:pk route, we want to fill the form with information related to the user using the primary key from the URL
    componentDidMount(){
    ...
    //tt calls the corresponding UsersService.createUser() method that makes the actual API call to the backend to create a user.
    handleCreate(){
